...
import {
  ...
  Award, Search, Instagram, Linkedin,
} from "lucide-react";
...
const WA_CERTIFICADOS   = `${WA_BASE}?text=Olá%2C%20gostaria%20de%20saber%20mais%20sobre%20os%20Certificados%20de%20Calibração`;
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 48, alignItems: "start" }}>
          ...
          <div>
            ...
            <h2 style={{ ...raj, fontSize: "clamp(22px,3vw,38px)", color: "#111", margin: "0 0 16px", lineHeight: 1.1 }}>
              O documento que{" "}
              <span style={{ color: "#F22020" }}>comprova a confiabilidade</span>{" "}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ ...raj, fontSize: "clamp(22px,3vw,38px)", color: "#111", margin: "0 0 12px", lineHeight: 1.1 }}>
            ...
            <span style={{ color: "#F22020" }}>certificado TECNOISO</span>
          </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
          {anatomiaItems.map(item => {
            ...
            return (
              <div key={item.title} style={{
                background: "#F9F9F9", border: "1.5px solid #EBEBEB", borderRadius: 12, padding: "22px",
    ...
    <section style={{ background: "#F5F5F5", padding: "64px 24px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ ...raj, fontSize: "clamp(22px,3vw,38px)", color: "#111", margin: "0 0 12px", lineHeight: 1.1 }}>
            Da sua planta ao{" "}
            <span style={{ color: "#F22020" }}>Sistema Internacional de Unidades</span>
          </h2>
          ...
          {rastreabilidadeSteps.map((step, i) => (
            <div key={step.num}>
              <div style={{
                ...
                <div style={{
                  width: 40, height: 40, borderRadius: 8, background: "#F22020",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  flexShrink: 0,
                }}>
              ...
              {i < rastreabilidadeSteps.length - 1 && (
                <div style={{ display: "flex", justifyContent: "center", padding: "6px 0" }}>
                  <div style={{ width: 2, height: 24, background: "#F22020", borderRadius: 2 }} />
                </div>
              )}
            </div>
          ))}
...
function FormSection({ formRef }: { formRef: React.RefObject<HTMLElement> }) {
  ...
  const [formData, setFormData] = useState({
    ...
    certType: "Acreditado RBC (CGCRE/INMETRO)", message: "",
  });
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <h2 style={{ ...raj, fontSize: "clamp(24px,3vw,40px)", color: "#fff", margin: "0 0 12px", lineHeight: 1.1 }}>
            Solicite seus{" "}
            <span style={{ color: "#F22020" }}>Certificados</span>
          </h2>
          ...
          <div style={{ padding: "36px" }}>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div>
                ...
                <select value={formData.certType} onChange={e => setFormData(p => ({ ...p, certType: e.target.value }))}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
                <button type="submit" disabled={isSubmitting} style={{
                  ...
                  {isSubmitting ? "Enviando..." : <>Solicitar Certificados <ArrowRight style={{ width: 16, height: 16 }} /></>}
                </button>
...
export default function CertificadosPage() {
  ...
  const scrollToAnatomia = () =>
    anatomiaRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
